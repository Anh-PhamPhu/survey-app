<template>
  <PageComponent title="Dashboard">
    ...
    >
      ...
      <div 
        class="row-span-2 animate-fade-in-down order-3 animate-fade-in-down lg:order-1 bg-white shadow-md p-4"
      >
        <h3 class="text-2xl font-semibold">Last Survey</h3>
        <img
      ...
      <div 
        class="bg-white shadow-md p-3 text-center flex flex-col order-4 lg:order-3 animate-fade-in-down"
